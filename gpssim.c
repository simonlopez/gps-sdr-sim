...
void usage(void)
{
	fprintf(stdout,"Usage: gps-sdr-sim [options]\n"
		"Options:\n"
...
int main(int argc, char *argv[])
{
	...
	{ 
		...
		// Added by scateu@gmail.com 
		fprintf(log,"Using static location mode.\n");
		llh2xyz(llh,xyz[0]); // Convert llh to xyz

		numd = iduration;
	}
/*
	fprintf(log,"xyz = %11.1f, %11.1f, %11.1f\n", xyz[0][0], xyz[0][1], xyz[0][2]);
	fprintf(log,"llh = %11.6f, %11.6f, %11.1f\n", llh[0]*R2D, llh[1]*R2D, llh[2]);
*/
	////////////////////////////////////////////////////////////
	// Read ephemeris
	////////////////////////////////////////////////////////////
	...
	{
		fprintf(log,"  %12.3e %12.3e %12.3e %12.3e\n", 
			ionoutc.alpha0, ionoutc.alpha1, ionoutc.alpha2, ionoutc.alpha3);
		fprintf(log,"  %12.3e %12.3e %12.3e %12.3e\n", 
			ionoutc.beta0, ionoutc.beta1, ionoutc.beta2, ionoutc.beta3);
		fprintf(log,"   %19.11e %19.11e  %9d %9d\n",
	...
	fprintf(log,"Start time = %4d/%02d/%02d,%02d:%02d:%02.0f (%d:%.0f)\n", 
		t0.y, t0.m, t0.d, t0.hh, t0.mm, t0.sec, g0.week, g0.sec);
	fprintf(log,"Duration = %.1f [sec]\n", ((double)numd)/10.0);
	...
	{
		if (chan[i].prn>0)
			fprintf(log,"%02d %6.1f %5.1f %11.1f %5.1f\n", chan[i].prn, 
	...
	for (iumd=1; iumd<numd; iumd++)
	{
		...
		// Update time counter
                if(iumd%100==0)
                {
		        fprintf(log,"\rTime into run = %4.1f", subGpsTime(grx, g0));
		        fflush(log);
                }
	}
	...
	// Process time
	fprintf(log,"Process time = %.1f [sec]\n", (double)(tend-tstart)/CLOCKS_PER_SEC);
